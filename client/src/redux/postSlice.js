...
export const postSlice = createSlice({
    ...
    reducers:{
        ...
        updatePost:(state,action) => {
            state.singPosts = action.payload.data.newPost;
        },
...
export const {updateLike,updateunLike,createPost,updateSuccess,updateStart,getUserPosts,postError,getSinglePost,deletePost,updatePost,allUserPost} = postSlice.actions 
